...
fn setup(
    ...
    commands.spawn((
        ...
        MeshMaterial3d(materials.add(Color::srgba(1.0, 1.0, 0.95, 0.9))),
    ...
    commands.spawn((
        ...
        MeshMaterial3d(materials.add(Color::srgba(0.3, 0.15, 0.9, rng))),
        TargetSphere,
    ));
    ...
    commands.spawn((
        Mesh3d(meshes.add(Sphere::new(0.3))),
        MeshMaterial3d(materials.add(Color::srgba(0.9, 0.3, 0.3, rng))),
